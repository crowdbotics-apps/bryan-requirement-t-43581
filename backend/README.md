...
## Project Structure
    ...
    ├── bryan_requirement_t_43581  # Django project configurations
...
1. Clone this repo and `cd bryan_requirement_t_43581`
...
2. Clone this repo and `cd bryan_requirement_t_43581`
